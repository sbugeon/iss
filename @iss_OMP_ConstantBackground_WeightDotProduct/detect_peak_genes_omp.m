function [PeakLocalYX,PeakSpotColors,PeakCoefs,PeakNeighbourhoodNonZeros,...
    OriginalTile] = ...
...
for GeneNo = 1:nCodes    
    ...
    NeighbNonZeroAnnulus = imfilter(NonZeroIm,AnnulusFilter,'symmetric');
    %NeighbNonZeros = imfilter(NonZeroIm,double(se1.Neighborhood));
    %NeighbNonZeros = NeighbPosNear + NeighbNonZeroAnnulus;
    NeighbNonZeros = [NeighbPosNear(:),NeighbNonZeroAnnulus(:)];
    ...
    Use = sum(PeakNeighbourhoodNonZeros{GeneNo},2)>o.ompInitialNeighbThresh;
