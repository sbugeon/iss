...
for t=1:length(NonemptyTiles)  
    ...
    tPeak2ndBestLogProb,tPeakScoreDev,tOriginalTile,tPeakBestGene] = ...
    ...
    clearvars tPeakLogProbOverBackground tPeak2ndBestLogProb tPeakScoreDev tOriginalTile tPeakBestGene;
    
    if ismember(t,OutputTileNo)
        save(o.PixelFileNames{FileIdx}, 'PeakSpotColors','PeakLocalYX', 'PeakLogProbOverBackground',...
            'Peak2ndBestLogProb','PeakScoreDev','OriginalTile','PeakBestGene', '-v7.3');
        PeakSpotColors = cell(nCodes,1);
        PeakLocalYX = cell(nCodes,1);
        PeakLogProbOverBackground = cell(nCodes,1);
        Peak2ndBestLogProb = cell(nCodes,1);
...
o.pxSpotCodeNo = int16(cell2mat(SpotCodeNo));
