...
%% o = o.register2;
% This finds spots on the reference image. Then it finds overlaps between
% tiles using point clouds by searching all possible shifts about the expected
% overlap as given by o.RegSearch.
