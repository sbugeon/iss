clear
SliceList = {'Round-'};
MainFolder = {'F:\445951\slide 23'};
OutputF = 'D:\ISS\445951\Slide23';
for iSlice = 1:length(SliceList)
    ...
    o.FileBase{8} = strcat(SliceNb,'15'); %anchor/dapi % 14;
...
%     save(fullfile(o.OutputDirectory,'oExtract'), 'o', '-v7.3');
    ...
    for j = 6:length(o.TileConnectedID)
...
I = imadjust(imread(fullfile(o.OutputDirectory,'background_image.tif')),[0 0.1]); % background image
...
GeneLegendPlot(8,o.GeneNames)
set(gcf,'Position',[844,738,984,347.6666666666667])
