clear
SliceList = {'Round-'};
MainFolder = {'\\NETDATA\Apotome\Stephane\445951\Slide20'};
OutputF = 'D:\ISS\445951\Slide20';
for iSlice = 1:length(SliceList)
    ...
    for j = 2:8
        ...
        o.RegSearch.South.X = -300:o.RegStep(2):300;
        o.RegSearch.East.Y = -300:o.RegStep(1):300;
        o.RegSearch.East.X = -1900:o.RegStep(2):-1700;
        o.RegWidenSearch = [150,150];
...
%% find tdTomato cells
GUI_findtdTomato('D:\ISS\445951\Slide20\Round-\output')
...
%     
%      I = imadjust(imread(fullfile(OutputF,Dn{i},'background_image_fixed.tif')),[0 0.01]);
